 ...
 * be automatically wrapped in a single use Runnable and added to its collection of Disposables.
 *
 ...
 * that you only add it to a {@link com.episode6.hackit.disposable.DisposableManager}
