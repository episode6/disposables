...
dependencies {
    // core modules
    compile 'com.episode6.hackit.disposable:disposables-core:0.0.8-SNAPSHOT'
    compile 'com.episode6.hackit.disposable:pausables-core:0.0.8-SNAPSHOT'

    // add-ons
    compile 'com.episode6.hackit.disposable:disposable-futures:0.0.8-SNAPSHOT'
    compile 'com.episode6.hackit.disposable:disposable-rx:0.0.8-SNAPSHOT'
    compile 'com.episode6.hackit.disposable:disposable-android:0.0.8-SNAPSHOT'
    compile 'com.episode6.hackit.disposable:disposable-butterknife:0.0.8-SNAPSHOT'
    compile 'com.episode6.hackit.disposable:pausable-android:0.0.8-SNAPSHOT'
}
```
